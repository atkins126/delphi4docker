...
- Remove everything that is IDE only related to [size down]([https://www.google.com](https://github.com/lmbelo/delphi4docker/wiki/Sizing-down-your-bundle)) your bundle.
